...
INSERT INTO "new_AgentConfig" ("componentId", "description", "disallowedTools", "hooks", "id", "memory", "model", "name", "permissionMode", "tools") SELECT "componentId", "description", "disallowedTools", "hooks", "id", "memory", "model", "name", "permissionMode", "tools" FROM "AgentConfig";
...
INSERT INTO "new_SkillConfig" ("agent", "allowedTools", "argumentHint", "componentId", "context", "description", "disableModelInvocation", "hooks", "id", "model", "name", "skillType", "userInvocable") SELECT "agent", "allowedTools", "argumentHint", "componentId", "context", "description", "disableModelInvocation", "hooks", "id", "model", "name", "skillType", "userInvocable" FROM "SkillConfig";
