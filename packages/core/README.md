...
| Export | Purpose |
|---|---|
| `@warabi1062/skillsmith-core/types` | Skill / plugin type definitions (`EntryPointSkill`, `WorkerSkill`, `WorkerWithSubAgent`, `WorkerWithAgentTeam`, `Teammate` (with optional `model`), `PluginDefinition`, `ToolRef`, etc.) |
